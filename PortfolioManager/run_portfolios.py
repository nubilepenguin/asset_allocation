...
from PortfolioManager.trader import *
from PortfolioManager.portfolio_manager import *
...
#portfolio_managers_list = [UniformAllocPM, IndividualPnlAllocPM, IndividualSharpeAllocPM, MarkowitzAllocPM, RegimePredictiveAllocPM]
...
def InitializePMs():
    pm_list, regime_pm = [], []
    contracts = {
        TrendFollowTrader: indep_shortcode_list,
...
def LoadMarketDataLines(shc_market_data_lines, shc_market_line_index):
    for shc in indep_shortcode_list:
        filename = '/Users/pengzhiyuan/PycharmProjects/asset_allocation/MarketData/csvs/market_data_' + shc + '.csv'
